  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className=" w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
        {isModerator && (
          <DropdownMenuItem className="text-indigo-600 dark:text-indigo-400 px-2 py-2 text-sm cursor-pointer">
            Invite People
            <UserPlus className="h-4 w-4 ml-auto" />
          </DropdownMenuItem>
        )}
        {isAdmin && (
          <DropdownMenuItem className=" dark:text-indigo-400 px-2 py-2 text-sm cursor-pointer">
            Server Settings
        ...
        {isAdmin && (
          <DropdownMenuItem className="text-rose-500 dark:text-indigo-400 px-2 py-2 text-sm cursor-pointer">
            Delete Server
